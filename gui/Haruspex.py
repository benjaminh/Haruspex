...
class Haruspex(QMainWindow):
    ...
    def initialize(self):
        ...
        self.create_menu()
        self.init_positioning(self.layout_p)
        self.show()
    ...
    def init_positioning(self, layout_p):
        ...
        self.top_layout.addWidget(ana_directory_label, 0, 0)
        self.top_layout.addWidget(self.ana_directory_edit, 0, 2)
        self.top_layout.addWidget(self.ana_directory, 0, 1)

        self.top_layout.addWidget(ana_bootstrap_label, 1, 0)
        self.top_layout.addWidget(self.ana_bootstrap, 1, 1)
        self.top_layout.addWidget(self.ana_bootstrap_button, 1, 2)

        self.top_layout.addWidget(self.ana_exec_button, 2, 1)

        self.top_layout.addWidget(ana_output_label, 3, 0)
        self.top_layout.addWidget(self.ana_output_edit, 3, 2)
        self.top_layout.addWidget(self.ana_output, 3, 1)

        self.top_layout.addWidget(self.ana_display_button, 4, 1)
        self.layout_p.addLayout(self.top_layout)
